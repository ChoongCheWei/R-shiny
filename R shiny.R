...
ui <- fluidPage(
  ...
  navbarPage(
    ...
    inverse = FALSE,
    title = (h1(strong("Stroke Analysis and Prediction")))
    ),
  ...
  tabsetPanel( 
    ...
    tabPanel("Overview",icon=icon("fas fa-globe"),
           fluidPage(
             ...
             fluidRow(column(width =6,h3 ("A stroke, sometimes called a brain attack, happens in one of two ways:")),br(), h3 (" (i) Ischemic stroke-when the blood supply to the brain is blocked"),   
                      img(src = stroke,height = "35%", width = "35%", style = "display: auto;"),),
             ...
             fluidRow(column(width =11, h3("Anyone, including children, can have a stroke at any time."))), 
             fluidRow(column(width =11, h3("There are several factors that that can increase your risk for stroke, includes age, sex, unhealthy eating habits and smoking."))),
             fluidRow(column(width =11, h3("In this application, we are using the dataset 'Stroke prediction dataset' from Kaggle to predict your stroke risk.")))
            ...
            tabPanel("Data Explorer",icon=icon("fas fa-search"),
              ...
              # ------------- App: Analysis ------------------------- 
                ...
                tabPanel("Prediction",icon=icon("fas fa-poll"),
                         ...
                         sidebarPanel(radioButtons("gender","Please select your gender",choices = c("Male" = 2, "Female" = 1)),
                                      numericInput("age","Please key your age",value=0,min=0,max=100),
                                      radioButtons("hypertension","Did your have hypertension?", choices = list("Yes" = 1, "No" = 0)),
                                      radioButtons("heart_disease","Did your have heart disease?",choices = list("Yes" = 1, "No" = 0)),
                                      radioButtons("ever_married","Did you married?",choices = list("Yes" = 2, "No" = 1)),
                                      radioButtons("work_type","Please select your work types",choices = list("Children" = 1, "Government" = 2, "Never Worked" = 3, "Private" = 4, "Self-employed" = 5)),
                                      radioButtons("Residence_type","Where are you live?", choices = list("Urban" = 2, "Rural" = 1)),
                                      numericInput("avg_glucose_level","Please key your average glucose level",value=0,min=0,max=300),
                                      numericInput("bmi","Please key in your bmi (bmi = kg.m2)",value=0,min=0,max=100),
                       ...
                       fluidPage(
                         ...
                         HTML("
                               <div style='background-color:white; padding: 5px 10px; border-radius: 5px; margin-bottom: 50px;'>
                                  ...
                                  <p> This page provides an overview of stroke. </p>
                                  <br/>
                                  <h4><i class=' fa fa-search fa-fw'></i><b> Data Explorer </b></h4>
                                  <p> This page tabulated the data used used in analysis and prediction. Descriptive analysis is provided.</p>
                                     <br/>
                                  <h4><i class=' fa fa-bar-chart-o fa-fw'></i><b> Analysis </b></h4>
                                  <p>W This page containes the interactive graph for users to visualised the correlations between variables.</p>
                                  <br/>
                                  <h4><i class=' fa fa-poll fa-fw'></i><b> Prediction </b></h4>
                                  <p> This page allow users to predict their stroke risk based on the infomration filled.</p>
                                </div>
                               "),
                         
                         fluidRow(column(width=11, h2(strong("References")))),
                         fluidRow(column(width=11, HTML("<p>Fedesoriano (2021). Stroke Prediction Dataset. Retrieved on Jan 10, 2022 from https://www.kaggle.com/fedesoriano/stroke-prediction-dataset"))),
                         fluidRow(column(width=11, HTML("<p>Stroke. Centers for Disease Control and Prevention. Retrieved on Jan 10, 2022 from https://www.cdc.gov/stroke/facts_stroke.htm"))),
